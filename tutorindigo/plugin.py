...
RUN npm install '@ex/frontend-component-footer@git+https://github.com/newliteraciesalliance/frontend-component-footer.git#sumac/indigo/nla'
RUN npm install '@edx/frontend-component-header@npm:@edly-io/indigo-frontend-component-header@^3.2.2'
RUN npm install '@edx/brand@git+https://github.com/newliteraciesalliance/brand-openedx#sumac/indigo-nla'
